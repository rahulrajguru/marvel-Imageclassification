...
# Separate directory for training and validation dataset 
...
train_black_widow_directory = os.path.join(train_directory, 'black widow')  
train_captian_america_directory = os.path.join(train_directory, 'captain america')  
...
validation_captian_america_directory = os.path.join(validation_directory, 'captain america')  
...
#print("Total black widow trainig images :",num_black_widow_train) 
##print("Total black widow validation images :",num_black_widow_val)
...
#rotaing the images to certain angel 
